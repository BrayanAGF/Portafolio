  ...
  return (
    <div className="w-full ">
       <iframe src='https://my.spline.design/interactivespherescopy-c3c9b1e90503307749b4751e874a63e2/' frameborder='0' width='100%' height='300px' style={{borderRadius: 6}} />
        ...
        <div className="relative bottom-14 md:left-8 pl-6">
          <div className="flex items-center gap-2">
            <p className="font-bold text-inherit Titulo text-4xl">Brayan Alberto</p>
          ...
          <div className="flex gap-3 w-auto">
            <div className="flex gap-2 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-backpack4-fill" viewBox="0 0 16 16">
            ...
            <div className="flex gap-2 items-center">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-cake-fill" viewBox="0 0 16 16">
